  ...
  <div class="collapse navbar-collapse" id="myNavbar">
	...
	<div class="well">
		<ul class="nav nav-pills nav-justified">
			...
			<form action="Menu.php" method="post"  >
				<button style="margin-left:17%" id="blackbutton" class="btn btn-primary"   value="Submit" name="Monday">Monday</button>
				<button  id="blackbutton" class="btn btn-primary" value="Submit" name="Tuesday">Tuesday</button>
				<button  id="blackbutton" class="btn btn-primary" value="Submit" name="Wednesday">Wednesday</button>
				<button  id="blackbutton" class="btn btn-primary" value="Submit" name="Thursday">Thursday</button>
				<button  id="blackbutton" class="btn btn-primary" value="Submit" name="Friday">Friday</button>
				<button  id="blackbutton" class="btn btn-primary" value="Submit" name="Saturday">Saturday</button>
				<button  id="blackbutton" class="btn btn-primary" value="Submit" name="Sunday">Sunday</button>
			</form>
		</ul>
    ...
    <table class="table table-striped">
      ...
      <?php
          ...
          $sql = "SELECT Items, halfPrice, fullPrice From Monday WHERE Meal='Breakfast'";
